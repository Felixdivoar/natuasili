-- Delete existing Ol Pejeta experiences first
DELETE FROM experiences WHERE slug LIKE '%ol-pejeta%';

-- Insert the Laikipia experiences for Ol Pejeta with new slugs
WITH ol_pejeta AS (

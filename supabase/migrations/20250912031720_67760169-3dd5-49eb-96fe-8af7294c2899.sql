-- Create partner profile for Ol Pejeta Conservancy using admin user
INSERT INTO partner_profiles (
    ...
    gen_random_uuid(),
    'dda219a2-4651-4bd1-8ddf-aff3c949db3f',
...
-- Now insert the Laikipia experiences for Ol Pejeta
WITH ol_pejeta AS (
  SELECT id FROM partner_profiles WHERE slug = 'ol-pejeta-conservancy'
)
...
SELECT 
  gen_random_uuid(),
  ol_pejeta.id,
  'northern-white-rhinos-conservancy',

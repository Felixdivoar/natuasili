...
const PartnerEntry = () => {
  ...
  const requirements = [t("Registered conservation organization or certified guide", "Registered conservation organization or certified guide"), t("Valid permits and insurance for tourism activities", "Valid permits and insurance for tourism activities"), t("Commitment to safety and conservation standards", "Commitment to safety and conservation standards"), t("Ability to provide authentic cultural and wildlife experiences", "Ability to provide authentic cultural and wildlife experiences"), t("Located in Kenya with local community partnerships", "Located in Kenya with local community partnerships")];
  const testimonials = [{
    name: "Sarah Kipkoech",

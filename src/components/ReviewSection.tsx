      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="text-center">
              ...
              <div className="flex items-center justify-center gap-1 mb-2">
                {[...Array(5)].map((_, i) => <Star key={i} className={`h-5 w-5 ${i < Math.floor(averageRating) ? "fill-primary text-primary" : "text-muted-foreground"}`} />)}
              </div>
            ...
            <div className="space-y-2">
              {[5, 4, 3, 2, 1].map(stars => <div key={stars} className="flex items-center gap-2">
                  ...
                  width: `${getRatingDistribution(stars)}%`
                }} />
                  </div>
          ...
          <div className="space-y-4">
            ...
            {mockReviews.map(review => <div key={review.id} className="border-b border-border pb-4 last:border-b-0">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => <Star key={i} className={`h-4 w-4 ${i < review.rating ? "fill-primary text-primary" : "text-muted-foreground"}`} />)}
                      </div>

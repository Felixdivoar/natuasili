...
export const mockExperiences: Experience[] = [
  ...
  // Colobus Conservation experiences
  {
    id: '14',
    project_id: '10',
    title: 'Primate Rescue & Rehabilitation Tour',
    slug: 'primate-rescue-rehabilitation-tour',
    description: 'Visit the rescue center, learn about primate welfare, and see conservation in action at Colobus Conservation.',
    images: [colobusConservation],
    location_text: 'Diani Beach, Coast',
    theme: 'Wildlife Conservation',
    activity_type: 'Education',
    duration_hours: 2.5,
    base_price: 85,
    ...
    capacity: 12,
    visible_on_marketplace: true,
    search_text: 'primate rescue rehabilitation colobus conservation diani coast',
  ...
  },
  {
    ...
    slug: 'guided-forest-walk-colobus',
    description: 'Discover the unique forest ecosystem and spot colobus monkeys in their natural habitat with expert guides.',
    images: [coastalForest],
    location_text: 'Diani Beach, Coast',
    theme: 'Conservation Education',
    activity_type: 'Tracking',
    duration_hours: 3,
    ...
    capacity: 10,
    visible_on_marketplace: true,
    search_text: 'forest walk colobus monkey tracking diani coastal forest',
    created_at: '2023-06-26T10:00:00Z'
  },
  // Reteti Elephant Sanctuary experiences
  {
    id: '16',
    project_id: '9',
    title: 'Elephant Feeding & Care Visit',
    slug: 'elephant-feeding-care-visit',
    description: 'Watch keepers bottle-feed baby elephants and learn how rescued calves are cared for at this community-owned sanctuary.',
    images: [retetiElephantOrphanage],
    location_text: 'Samburu, Namunyak Conservancy',
    theme: 'Wildlife Conservation',
    activity_type: 'Education',
    duration_hours: 2,
    base_price: 120,
    ...
    capacity: 8,
    visible_on_marketplace: true,
    search_text: 'elephant feeding care baby elephants reteti samburu sanctuary',
    created_at: '2023-06-27T10:00:00Z'
  },
  {
    id: '17',
    project_id: '9',
    title: 'Behind-the-Scenes Sanctuary Tour',
    slug: 'sanctuary-behind-scenes-tour',
    description: 'A closer look at the work of community keepers, from rescue to rehabilitation at Reteti Elephant Sanctuary.',
    images: [retetiElephantOrphanage],
    location_text: 'Samburu, Namunyak Conservancy',
    theme: 'Conservation Education',
    activity_type: 'Education',
    ...
    capacity: 6,
    visible_on_marketplace: true,
    search_text: 'sanctuary behind scenes elephants reteti samburu community keepers',
    created_at: '2023-06-28T10:00:00Z'
  },
  // Mara Elephant Project experiences (additional to existing)
  {
    id: '18',
    project_id: '7',
    title: 'Ranger Patrol Shadowing',
    slug: 'ranger-patrol-shadowing',
    description: 'Join rangers on patrol to see how they monitor elephant safety and fight poaching in the Greater Mara.',
    images: [maraElephantTracking],
    location_text: 'Maasai Mara Greater Ecosystem',
    theme: 'Wildlife Conservation',
    activity_type: 'Community',
    ...
    capacity: 4,
    visible_on_marketplace: true,
    search_text: 'ranger patrol elephant protection mara anti-poaching conservation',
    created_at: '2023-06-29T10:00:00Z'
  },
  // Nature Kenya experiences (additional to existing)
  {
    id: '19',
    project_id: '4',
    title: 'Community Conservation Projects Tour',
    slug: 'community-conservation-projects-tour',
    description: 'Visit grassroots initiatives preserving key habitats with Nature Kenya, Africa\'s oldest conservation society.',
    images: [natureKenyaBirdwatching],
    location_text: 'Nairobi and surroundings',
    theme: 'Conservation Education',
    activity_type: 'Community',
    duration_hours: 4,
    base_price: 90,
    ...
    capacity: 12,
    visible_on_marketplace: true,
    search_text: 'community conservation projects nature kenya grassroots habitat',
    created_at: '2023-06-30T10:00:00Z'
  },
  // Friends of Karura Forest experiences (additional to existing)
  {
    id: '20',
    project_id: '6',
    title: 'Guided Nature Walk in Karura',
    slug: 'guided-nature-walk-karura',
    description: 'Explore caves, waterfalls, and indigenous trees with local guides in Nairobi\'s iconic urban forest.',
    images: [karuraForestPlanting],
    location_text: 'Karura Forest Reserve, Nairobi',
    theme: 'Conservation Education',
    activity_type: 'Tracking',
    duration_hours: 2.5,
    base_price: 45,
    ...
    capacity: 15,
    visible_on_marketplace: true,
    search_text: 'guided nature walk karura forest caves waterfalls nairobi urban',
